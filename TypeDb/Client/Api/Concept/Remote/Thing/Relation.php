...
use TypeDb\Client\Api\Concept\Thing\Relation as RelationLocal;
use TypeDb\Client\Api\Concept\Type\RoleType;

interface Relation extends RelationLocal, Concept {
    ...
    public function getPlayers(array $roleTypes); //stream

    public function getPlayersByRoleType(): array;

    public function getRelating(); //stream
