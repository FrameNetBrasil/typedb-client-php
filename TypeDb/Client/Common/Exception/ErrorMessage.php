...
public function class ErrorMessage extends com.vaticle.typedb.common.exception.ErrorMessage : abstract{
    ...
    public function class Client extends ErrorMessage : static{
        public function final Client CLIENT_CLOSED =
        ...
        Client(int number, string message) : static{
            super(codePrefix, number, messagePrefix, message);
        }
    }

    public function class Concept extends ErrorMessage : static{
        public function final Concept INVALID_CONCEPT_CASTING =
        ...
        Concept(int number, string message) : static{
            super(codePrefix, number, messagePrefix, message);
        }
    }

    public function class Query extends ErrorMessage : static{
        public function final Query VARIABLE_DOES_NOT_EXIST =
        ...
        Query(int number, string message) : static{
            super(codePrefix, number, messagePrefix, message);
        }
    }

    public function class Internal extends ErrorMessage : static{
        public function final Internal UNEXPECTED_INTERRUPTION =
        ...
        Internal(int number, string message) : static{
            super(codePrefix, number, messagePrefix, message);
        }
    }
}
