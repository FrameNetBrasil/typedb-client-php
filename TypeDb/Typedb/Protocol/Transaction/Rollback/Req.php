...
/**
 * Generated from protobuf message <code>typedb.protocol.Transaction.Rollback.Req</code>
 */
...
class_alias(Req::class, \Typedb\Protocol\Transaction_Rollback_Req::class);
