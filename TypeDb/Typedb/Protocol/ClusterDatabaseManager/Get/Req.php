...
/**
 * Generated from protobuf message <code>typedb.protocol.ClusterDatabaseManager.Get.Req</code>
 */
...
class_alias(Req::class, \Typedb\Protocol\ClusterDatabaseManager_Get_Req::class);
