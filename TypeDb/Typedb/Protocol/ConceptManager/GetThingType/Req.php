...
/**
 * Generated from protobuf message <code>typedb.protocol.ConceptManager.GetThingType.Req</code>
 */
...
class_alias(Req::class, \Typedb\Protocol\ConceptManager_GetThingType_Req::class);
