...
namespace Typedb\Protocol\Relation\AddPlayer;
...
/**
 * Generated from protobuf message <code>typedb.protocol.Relation.AddPlayer.Req</code>
 */
...
class_alias(Req::class, \Typedb\Protocol\Relation_AddPlayer_Req::class);
