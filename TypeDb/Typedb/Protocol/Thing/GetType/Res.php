...
namespace Typedb\Protocol\Thing\GetType;
...
/**
 * Generated from protobuf message <code>typedb.protocol.Thing.GetType.Res</code>
 */
class Res extends \Google\Protobuf\Internal\Message
{
    ...
    {
        return isset($this->thing_type);
    }

    public function clearThingType()
    {
        unset($this->thing_type);
    }
...
class_alias(Res::class, \Typedb\Protocol\Thing_GetType_Res::class);
