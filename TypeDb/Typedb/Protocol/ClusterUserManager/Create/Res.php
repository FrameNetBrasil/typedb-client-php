...
/**
 * Generated from protobuf message <code>typedb.protocol.ClusterUserManager.Create.Res</code>
 */
...
class_alias(Res::class, \Typedb\Protocol\ClusterUserManager_Create_Res::class);
