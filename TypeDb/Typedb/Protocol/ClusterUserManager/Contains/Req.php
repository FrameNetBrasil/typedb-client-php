...
/**
 * Generated from protobuf message <code>typedb.protocol.ClusterUserManager.Contains.Req</code>
 */
...
class_alias(Req::class, \Typedb\Protocol\ClusterUserManager_Contains_Req::class);
